...
CREATE TABLE question (questionid UUID NOT NULL, surveyid UUID NOT NULL, type CHARACTER VARYING(50) NOT NULL, question CHARACTER VARYING(100) NOT NULL, possible_responses CHARACTER VARYING(500), data JSON, multiple_choice BOOLEAN, has_other BOOLEAN, other_label CHARACTER VARYING, sequence INTEGER DEFAULT 1 NOT NULL, PRIMARY KEY (questionid));
DROP TABLE IF EXISTS response;
CREATE TABLE response (userid UUID NOT NULL, surveyid UUID NOT NULL, questionid UUID NOT NULL, answers CHARACTER VARYING(500), other CHARACTER VARYING(500), skipped BOOLEAN DEFAULT false, responseid UUID NOT NULL, PRIMARY KEY (responseid), UNIQUE (userid, surveyid, questionid));
