...
CREATE TABLE schedule (scheduleid UUID NOT NULL, label CHARACTER VARYING NOT NULL, userid UUID NOT NULL, dow_mask CHARACTER VARYING(7), start_dt DATE, end_dt DATE, repeats BOOLEAN, type CHARACTER VARYING, data JSON, PRIMARY KEY (scheduleid));
